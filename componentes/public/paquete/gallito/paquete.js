...
var PaqueteGallito = function () {
	function PaqueteGallito() {
		_classCallCheck(this, PaqueteGallito);

		this.confSlider();
		this.iniciar();
	}

	_createClass(PaqueteGallito, [{
		key: "confSlider",
    ...
    */
	...
	return PaqueteGallito;
}();

$(document).on("ready", inicio);
function inicio() {
	var obj = new PaqueteGallito();
}