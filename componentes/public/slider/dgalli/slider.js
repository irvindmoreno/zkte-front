...
var SliderDgalli = function () {
	function SliderDgalli() {
		_classCallCheck(this, SliderDgalli);

		this.confSlider();
		this.iniciar();
		$(".btn-menuDesplegable-logo").on("click", this.abrirMenuDesplegable);
		$(".cerrar-MenuDesplegable").on("click", this.cerrarMenuDesplegable);
		setInterval(function () {
			/* igualaremos altura de los divs*/
			var altuta = $("#demo").height();
			if (altuta > 560) {
				$(".contenidoMenuDesplegable").css("height", altuta + "px");
			}
		}, 500);
	}

	_createClass(SliderDgalli, [{
		key: "confSlider",
    ...
    */
		...
		key: "cerrarMenuDesplegable",
		value: function cerrarMenuDesplegable() {
			$(".bloque-nosotros").addClass("hideDiv");
			$(".bloque-flecha").addClass("hideDiv");
			$('.contenidoMenuDesplegable').animate({ width: 'toggle' });
		}
	}, {
		key: "abrirMenuDesplegable",
		value: function abrirMenuDesplegable() {
			$('.contenidoMenuDesplegable').animate({ width: 'toggle' }, function () {
				$(".bloque-nosotros").removeClass("hideDiv");
				$(".bloque-flecha").removeClass("hideDiv");
			});
		}
	}, {
		key: "iniciar",
...
var ContadoresGallito = function ContadoresGallito() {
	_classCallCheck(this, ContadoresGallito);
};

var PostGallito = function PostGallito() {
	_classCallCheck(this, PostGallito);
};