...
var SliderGallitoB = function () {
	function SliderGallitoB() {
		_classCallCheck(this, SliderGallitoB);

		this.confSlider();
		this.iniciar();
	}

	_createClass(SliderGallitoB, [{
		key: "confSlider",
    ...
    */
		...
		value: function iniciar() {
			...
			//asignaremos el tamño de la imagen a la descripcion

		}
	}]);

	return SliderGallitoB;
}();

$(document).on("ready", inicio);
function inicio() {
	var obj = new SliderGallitoB();
}