...
var SliderTodobusco = function () {
	function SliderTodobusco() {
		_classCallCheck(this, SliderTodobusco);

		this.confSlider();
		this.iniciar();
	}

	_createClass(SliderTodobusco, [{
		key: "confSlider",
    ...
    */
	...
	return SliderTodobusco;
}();

$(document).on("ready", inicio);
function inicio() {
	var obj = new SliderTodobusco();
}