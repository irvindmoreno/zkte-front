...
var FormularioGallitoRegistro = function () {
		...
		_createClass(FormularioGallitoRegistro, [{
				...
				value: function addEstudio(event) {
						...
						//$("#slider_estudios_carrusel").trigger('remove.owl.carousel');
						...
						var template = "<div class=\"item\">\n\t\t\t  <div class=\"contenedor-icon-gallito-perfil\">\n\t\t\t    <div class=\"contenedor-title-borde\"><span class=\"title-text-borde\">Estudios(" + nroSliderEstudios + ")</span>\n\t\t\t      <div class=\"borde-inferior-titulo\"></div>\n\t\t\t    </div>\n\t\t\t  </div>\n\t\t\t  <div class=\"contenedor-datos-cargo\">\n\t\t\t    <div class=\"row smb cont-file\">\n\t\t\t      <div class=\"col-sm-2 col-md-2 spb align-middle-text\"><span class=\"text-2-line \">Carrera (*)</span></div>\n\t\t\t      <div class=\"col-sm-7 col-md-7 spb align-middle\">\n\t\t\t        <select name=\"select_carrera\" class=\"input_form_perfil select_color\">\n\t\t\t          <option value=\"\">Seleccione</option>\n\t\t\t          <option value=\"1\">Informática</option>\n\t\t\t          <option value=\"2\">Sistemas</option>\n\t\t\t          <option value=\"3\">Idiomas</option>\n\t\t\t        </select>\n\t\t\t      </div>\n\t\t\t    </div>\n\t\t\t    <div class=\"row smb cont-file\">\n\t\t\t      <div class=\"col-sm-2 col-md-2 spb align-middle-text\"><span class=\"text-2-line \">Tipo de carrera (*)</span></div>\n\t\t\t      <div class=\"col-sm-7 col-md-7 spb align-middle\">\n\t\t\t        <select name=\"select_carrera\" class=\"input_form_perfil select_color\">\n\t\t\t          <option value=\"\">Seleccione</option>\n\t\t\t          <option value=\"1\">Informática</option>\n\t\t\t          <option value=\"2\">Sistemas</option>\n\t\t\t          <option value=\"3\">Idiomas</option>\n\t\t\t        </select>\n\t\t\t      </div>\n\t\t\t    </div>\n\t\t\t    <div class=\"row smb cont-file\">\n\t\t\t      <div class=\"col-sm-2 col-md-2 spb align-middle-text\"><span class=\"text-2-line \">Nivel (*)</span></div>\n\t\t\t      <div class=\"col-sm-7 col-md-7 spb align-middle\">\n\t\t\t        <select name=\"select_carrera\" class=\"input_form_perfil select_color\">\n\t\t\t          <option value=\"\">Seleccione</option>\n\t\t\t          <option value=\"1\">Informática</option>\n\t\t\t          <option value=\"2\">Sistemas</option>\n\t\t\t          <option value=\"3\">Idiomas</option>\n\t\t\t        </select>\n\t\t\t      </div>\n\t\t\t    </div>\n\t\t\t  </div>\n\t\t\t</div>";
						$("#slider_estudios_carrusel").append(template);
						$('#slider_estudios_carrusel').data('owlCarousel').reinit();
						$('#slider_estudios_carrusel').trigger('owl.goTo', nroSliderEstudios);

						//agregando el numero al paginador
						var templatePagination = "<input type=\"button\" class=\"pagination-formulario active-pagination\" value=\"" + nroSliderEstudios + "\" />";
						$(".content-pagination").append(templatePagination);

						$(".pagination-formulario").on("click", function () {
								$('#slider_estudios_carrusel').trigger('owl.goTo', $(this).val() - 1);
								$(".pagination-formulario").removeClass("active-pagination");
								$(this).addClass("active-pagination");
						});
						// agregando las reglas
						/*
      $( `#nombreInstitucional-${nroSliderEstudios}` ).rules( "add", {
      required: true
      });
      $( `#select_carrera-${nroSliderEstudios}` ).rules( "add", {
      required: true
      });
      $( `#select_tipo_carrera-${nroSliderEstudios}` ).rules( "add", {
      required: true
      });
      $( `#select_nivel-${nroSliderEstudios}` ).rules( "add", {
      required: true
      });
      $( `#select_inicio-${nroSliderEstudios}` ).rules( "add", {
      required: true
      });
      $( `#select_mes-${nroSliderEstudios}` ).rules( "add", {
      required: true
      });*/
				}
		}, {
				...
				value: function iniciarSlider() {
						var owl = $("#slider_estudios_carrusel");
