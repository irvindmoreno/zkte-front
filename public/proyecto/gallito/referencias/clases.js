...
var FormularioGallito = function () {
				function FormularioGallito() {
								...
								this.confSlider();
								$("#addEstudio").on("click", this.addEstudio);
								this.iniciarSlider();
				...
				_createClass(FormularioGallito, [{
								...
								value: function addEstudio() {
												...
												var template = "<div class=\"item\">\n\t\t  <div class=\"contenedor-formulario-gallito\">\n\t\t    <div class=\"contenedor-icon-gallito-perfil\">\n\t\t      <div class=\"contenedor-title-borde\"><span class=\"title-text-borde-2\">Referencia(" + nroDeSlider + ")</span>\n\t\t        <div class=\"borde-inferior-titulo\"></div>\n\t\t      </div>\n\t\t      <div class=\"row smb cont-file\">\n\t\t        <div class=\"col-md-12 spb\">\n\t\t          <label for=\"check_no_tengo_estudios\" class=\"label-form-gallito\">Recuerda que las referencias que las empresas toman en cuenta son tus últimos trabajos.</label>\n\t\t        </div>\n\t\t      </div>\n\t\t      <div class=\"row smb cont-file\">\n\t\t        <div class=\"col-sm-2 col-md-2 spb\"><span class=\"text-2-line\">Nombre de la referencia (*)</span></div>\n\t\t        <div class=\"col-sm-7 col-md-7 spb align-middle cont-msj-relative\">\n\t\t          <input type=\"text\" name=\"name_nombre_referencia-" + nroDeSlider + "\" id=\"id_nombre_referencia-" + nroDeSlider + "\" placeholder=\"Ingrese nombre de la institución\" class=\"input_form_perfil\"/>\n\t\t        </div>\n\t\t        <div class=\"col-sm-3 col-md-3 spb align-middle-text cont-module-error\">\n\t\t          <div class=\"icon-alert icon-inline icon-alert-left hideDiv\"></div>\n\t\t          <div class=\"error-format text-2-line-error\"></div>\n\t\t        </div>\n\t\t      </div>\n\t\t      <div class=\"row smb cont-file\">\n\t\t        <div class=\"col-sm-2 col-md-2 spb align-middle-text\"><span class=\"text-1-line \">Cargo (*)</span></div>\n\t\t        <div class=\"col-sm-7 col-md-7 spb align-middle cont-msj-relative\">\n\t\t          <select name=\"name_cargo-" + nroDeSlider + "\" id=\"id_name_cargo-" + nroDeSlider + "\" class=\"input_form_perfil select_color\">\n\t\t            <option value=\"\">Seleccione</option>\n\t\t            <option value=\"1\">Informática</option>\n\t\t            <option value=\"2\">Sistemas</option>\n\t\t            <option value=\"3\">Idiomas</option>\n\t\t          </select>\n\t\t        </div>\n\t\t        <div class=\"col-sm-3 col-md-3 spb align-middle-text cont-module-error\">\n\t\t          <div class=\"icon-alert icon-inline icon-alert-left hideDiv\"></div>\n\t\t          <div class=\"error-format text-2-line-error\"></div>\n\t\t        </div>\n\t\t      </div>\n\t\t      <div class=\"row smb cont-file\">\n\t\t        <div class=\"col-sm-2 col-md-2 spb\"><span class=\"text-1-line\">Nivel (*)</span></div>\n\t\t        <div class=\"col-sm-7 col-md-7 spb cont-msj-relative\">\n\t\t          <select name=\"name_nivel-" + nroDeSlider + "\" id=\"id_nivel-" + nroDeSlider + "\" class=\"input_form_perfil select_color\">\n\t\t            <option value=\"\">Seleccione</option>\n\t\t            <option value=\"1\">Informática</option>\n\t\t            <option value=\"2\">Sistemas</option>\n\t\t            <option value=\"3\">Idiomas</option>\n\t\t          </select>\n\t\t        </div>\n\t\t        <div class=\"col-sm-3 col-md-3 spb align-middle-text cont-module-error\">\n\t\t          <div class=\"icon-alert icon-inline icon-alert-left hideDiv\"></div>\n\t\t          <div class=\"error-format text-2-line-error\"></div>\n\t\t        </div>\n\t\t      </div>\n\t\t      <div class=\"row smb cont-file\">\n\t\t        <div class=\"col-sm-2 col-md-2 spb align-middle-text\"><span class=\"text-2-line\">Tiempo de Experiencia (*)</span></div>\n\t\t        <div class=\"col-sm-7 col-md-7 spb cont-msj-relative\">\n\t\t          <select name=\"name_experiencia-" + nroDeSlider + "\" id=\"id_experiencia-" + nroDeSlider + "\" class=\"input_form_perfil select_color\">\n\t\t            <option value=\"\">Seleccione</option>\n\t\t            <option value=\"1\">Informática</option>\n\t\t            <option value=\"2\">Sistemas</option>\n\t\t            <option value=\"3\">Idiomas</option>\n\t\t          </select>\n\t\t        </div>\n\t\t        <div class=\"col-sm-3 col-md-3 spb align-middle-text cont-module-error\">\n\t\t          <div class=\"icon-alert icon-inline icon-alert-left hideDiv\"></div>\n\t\t          <div class=\"error-format text-2-line-error\"></div>\n\t\t        </div>\n\t\t      </div>\n\t\t      <div class=\"row smb cont-file\">\n\t\t        <div class=\"col-sm-3 col-md-2 spb\"><span class=\"text-1-line\">Teléfono</span></div>\n\t\t        <div class=\"col-sm-6 col-md-7 spb align-middle\">\n\t\t          <input type=\"text\" maxlength=\"100\" name=\"name_telefono-" + nroDeSlider + "\" id=\"id_telefono-" + nroDeSlider + "\" placeholder=\"Ingrese nombre comercial\" class=\"input_form_perfil\"/>\n\t\t        </div>\n\t\t        <div class=\"col-sm-3 col-md-3 spb align-middle-text cont-module-error\">\n\t\t          <div class=\"icon-alert icon-inline icon-alert-left hideDiv\"></div>\n\t\t          <div class=\"error-format text-2-line-error\"></div>\n\t\t        </div>\n\t\t      </div>\n\t\t      <div class=\"row smb cont-file\">\n\t\t        <div class=\"col-sm-3 col-md-2 spb\"><span class=\"text-1-line\">Celular (*)</span></div>\n\t\t        <div class=\"col-sm-6 col-md-7 spb align-middle\">\n\t\t          <input type=\"text\" maxlength=\"100\" name=\"name_celular-" + nroDeSlider + "\" id=\"id_celular-" + nroDeSlider + "\" placeholder=\"Ingrese nombre comercial\" class=\"input_form_perfil\"/>\n\t\t        </div>\n\t\t        <div class=\"col-sm-3 col-md-3 spb align-middle-text cont-module-error\">\n\t\t          <div class=\"icon-alert icon-inline icon-alert-left hideDiv\"></div>\n\t\t          <div class=\"error-format text-2-line-error\"></div>\n\t\t        </div>\n\t\t      </div>\n\t\t      <div class=\"row smb cont-file\">\n\t\t        <div class=\"col-sm-3 col-md-2 spb\"><span class=\"text-1-line\">Correo (*)</span></div>\n\t\t        <div class=\"col-sm-6 col-md-7 spb align-middle\">\n\t\t          <input type=\"text\" maxlength=\"100\" name=\"name_correo-" + nroDeSlider + "\" id=\"id_correo-" + nroDeSlider + "\" placeholder=\"Ingrese nombre comercial\" class=\"input_form_perfil\"/>\n\t\t        </div>\n\t\t        <div class=\"col-sm-3 col-md-3 spb align-middle-text cont-module-error\">\n\t\t          <div class=\"icon-alert icon-inline icon-alert-left hideDiv\"></div>\n\t\t          <div class=\"error-format text-2-line-error\"></div>\n\t\t        </div>\n\t\t      </div>\n\t\t    </div>\n\t\t  </div>\n\t\t</div>";
												...
												$("#id_nombre_referencia-" + nroDeSlider).rules("add", {
																required: true
												});
												$("#id_name_cargo-" + nroDeSlider).rules("add", {
																required: true
												});
												$("#id_nivel-" + nroDeSlider).rules("add", {
																required: true
												});
												$("#id_experiencia-" + nroDeSlider).rules("add", {
																required: true
												});
												$("#id_telefono-" + nroDeSlider).rules("add", {
																required: true
												});
												$("#id_celular-" + nroDeSlider).rules("add", {
																required: true
												});
												$("#id_correo-" + nroDeSlider).rules("add", {
																required: true
												});
								}
				}, {
